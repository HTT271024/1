#!/usr/bin/env python3
# HTTP/1.1 Quick Test Script for S0 baseline
# Modified from http1_only.py with minimal parameters for faster execution
...
RESULT_DIR = "/home/ekko/ns-3-dev-new/scratch/Comparison/results/http1_quick"  # Results directory
